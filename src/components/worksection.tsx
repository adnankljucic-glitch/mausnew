...
const projects: Project[] = [
  {
    ...
    videoUrl: "https://media.maus.ba/media/imccersd/runevents_intro.mp4",
    posterImage: "https://media.maus.ba/media/5egd42ru/runeventsload.webp?width=1920&v=1da47bb2de108f0",
    mediaType: "video",
    slug: "run-events",
  },
  {
    ...
    videoUrl: "https://media.maus.ba/media/ghshptkb/intro_hosipital.mp4",
    posterImage: "https://media.maus.ba/media/p1kjrd31/sygehusload.webp?width=1920&v=1da47bb2dea30b0",
    mediaType: "video",
  },
  {
    id: 3,
