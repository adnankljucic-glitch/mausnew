...
const expertiseCards = [
  {
    ...
    body: 'We architect booking engines that process concurrent requests without double-bookings — distributed locking, event sourcing, and optimistic concurrency handled at the infrastructure level.',
  ...
  },
  {
    ...
    body: 'Demand forecasting, dynamic pricing models, and occupancy analytics — we build the intelligence layer that helps operators fill capacity and optimise yield.',
...
const capabilities = [
  {
    ...
    desc: 'Custom reservation cores built for your domain — events, travel, venues, or services.',
    icon: (
  ...
  },
  {
    num: '02',
    title: 'Ticketing & QR',
    desc: 'End-to-end ticket lifecycle with digital delivery, scanning, and gate management.',
    icon: (
      <svg viewBox="0 0 40 40" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round">
  ...
  },
  {
    num: '04',
    title: 'CRM & Loyalty',
    desc: 'Customer profiles, purchase history, and loyalty programmes that drive repeat bookings.',
    icon: (
      <svg viewBox="0 0 40 40" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round">
  ...
  },
  {
    ...
    desc: 'Real-time occupancy, revenue, and demand insight for operators and venue managers.',
    icon: (
      <svg viewBox="0 0 40 40" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round">
...
export default function BookingTicketingSections() {
  ...
  return (
    <>
      <IndustryIntroSection
        label="02 — Booking & Ticketing"
        headline={<>Where millions of transactions meet <em>zero tolerance for errors</em>.</>}
        body={[
          'Booking and ticketing is one of the most demanding software domains. A sold-out concert, a flight departure, a sold property — these are moments that cannot fail. Concurrency, latency, and payment integrity are not features. They are the product.',
          'We have built reservation systems that handle hundreds of thousands of simultaneous users, event ticketing platforms deployed across multiple countries, and booking engines deeply integrated with third-party inventory and pricing systems.',
        ...
        <div className="manyone-grid">
          ...
          >
            ...
            <p className="hc-expertise-lead">
              We combine deep platform engineering with commerce domain knowledge — delivering booking and ticketing systems that operators, partners, and customers can rely on at every peak moment.
            </p>
          </motion.div>
      ...
      <section ref={capRef} className="hc-capabilities">
        <div className="manyone-grid">
          ...
          >
            ...
            <h2 className="hc-capabilities-headline">Everything you need to run a world-class booking platform.</h2>
            <p className="hc-capabilities-lead">
              Full-stack expertise across commerce, infrastructure, and user experience — one team to take you from concept to millions of bookings.
            </p>
          </motion.div>
