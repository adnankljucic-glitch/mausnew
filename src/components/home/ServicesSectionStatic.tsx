...
function ServicesSectionStatic() {
  ...
  return (
    <section id="services-static" className="solution-section-static">
      <div className="manyone-grid">
        <h2 className="solution-headline-static">Explore our services</h2>
        <p className="solution-subheadline-static">At MAUS, we don't just write code; we solve business complexity. Through Specs Driven Development (SDD) and a deep-dive Discovery phase, we transform legacy constraints into scalable, high-performance digital assets for ambitious enterprises.</p>
