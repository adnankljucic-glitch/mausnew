      ...
      <div className="manyone-grid">
        <div className="process-step-wrapper">
          <motion.div className="process-step-text-content" variants={textVariants}>
            <h2 className="process-step-headline">Speed that drives conversion</h2>
            <p className="process-step-paragraph">
              Every millisecond matters. Slow applications lose users and revenue. We optimize every layer of your stack to deliver sub-second response times that keep users engaged and conversions flowing.
            </p>
          ...
          >
            ...
            <div className="process-step-image-overlay">
              <h3 className="process-step-image-headline">Performance optimization</h3>
            </div>
          </motion.div>
        </div>
      </div>
