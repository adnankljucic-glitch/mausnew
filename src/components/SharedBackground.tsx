...
export const GradientPlaneCases = () => {
  ...
  const uniforms = useMemo(
    () => ({
      uTime: { value: 0 },
      uColor1: { value: new THREE.Color("#02040a") },
      uColor2: { value: new THREE.Color("#134e4a") },
      uColor3: { value: new THREE.Color("#10b981") },
      uColor4: { value: new THREE.Color("#34d399") },
    }),
    []
  );
...
export const GradientPlaneExpertise = () => {
  ...
  const uniforms = useMemo(
    () => ({
      uTime: { value: 0 },
      uColor1: { value: new THREE.Color("#041432") },
      uColor2: { value: new THREE.Color("#0a2460") },
      uColor3: { value: new THREE.Color("#5F024E") },
      uColor4: { value: new THREE.Color("#3a012f") },
    }),
    []
  );
